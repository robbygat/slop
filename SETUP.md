...
- **SLOP Pro** → recurring price **$5/mo** → copy its Price ID → `STRIPE_PRICE_PRO`
- **600 credits** → one-time **$5** → Price ID → `STRIPE_PRICE_TOPUP_SMALL`
- **3000 credits** → one-time **$20** → Price ID → `STRIPE_PRICE_TOPUP_LARGE`
...
# or individually:
supabase secrets set XAI_API_KEY=...           # console.x.ai
supabase secrets set OPENAI_API_KEY=...         # platform.openai.com/api-keys
supabase secrets set ANTHROPIC_API_KEY=sk-ant-... # console.anthropic.com
supabase secrets set STRIPE_SECRET_KEY=sk_test_...
supabase secrets set STRIPE_PRICE_PRO=price_...
supabase secrets set STRIPE_PRICE_TOPUP_SMALL=price_...
supabase secrets set STRIPE_PRICE_TOPUP_LARGE=price_...
